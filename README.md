About pymdown-extensions-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pymdown-extensions-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pymdown-extensions-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pymdown-extensions
# for installing globally
pixi global install pymdown-extensions
```
...
It is possible to list all of the versions of `pymdown-extensions` available on your platform:
...
```
pixi search pymdown-extensions --channel conda-forge
```
